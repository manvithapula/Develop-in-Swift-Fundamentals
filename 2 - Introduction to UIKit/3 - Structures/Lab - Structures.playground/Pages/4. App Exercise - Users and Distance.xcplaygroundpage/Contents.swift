...
var user1 = User(username: "rorygilmore", age: 20 height: 157, weight: 40, activityLevel: 7)
print("\(user1.username), \(user1.age), with a height of \(user1.height) cm and a weight of \(user1.weight) kg has an activity level of \(user1.activityLevel)")
