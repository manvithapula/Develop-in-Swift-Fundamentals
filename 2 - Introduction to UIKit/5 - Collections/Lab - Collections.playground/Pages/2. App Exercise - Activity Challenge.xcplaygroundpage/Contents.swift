 ...
 */
var walkingChallenge: [String] = ["Walk 3 miles a day", "Walk up stairs instead of using elevator"]
var runningChallenge: [String] = ["Run 5 days a week", "Run 100 miles in a month"]
...
} else if committedChallenge.count == 1 {
    print("The challenge you have chosen is \(committedChallenge[0])")
} else {
